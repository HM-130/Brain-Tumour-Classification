...
Model 5 | No | No | Yes | 0.9657 | 0.1469""", language='text')
    ...
    st.text(
        ...
        "This project developed my understanding of both machine learning techniques and their limitations when applied to complex biological data, particularly within the context of neuroscience and medical imaging. "
